...
export class ServiceNowProxyAdapter implements IServiceNowClient {
  ...
  async createIncident(
    ...
    return this.tracing.run(
      'monolith.proxy.sn.createIncident',
      { kind: 'client' },
  ...
  async createRequest(
    ...
    return this.tracing.run(
      'monolith.proxy.sn.createRequest',
      { kind: 'client' },
  ...
  async enqueueIncident(
    ...
    return this.tracing.run(
      'monolith.proxy.sn.enqueueIncident',
      { kind: 'client' },
  ...
  async enqueueRequest(
    ...
    return this.tracing.run(
      'monolith.proxy.sn.enqueueRequest',
      { kind: 'client' },
  ...
  > {
    return this.tracing.run(
      'monolith.proxy.sn.getCompanies',
      { kind: 'client' },
      () => this._getCompanies(),
    );
  }
