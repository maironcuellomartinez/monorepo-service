...
import { TechnicianId, CornerId, UserId } from '../../../../core/domain/value-objects/ids';
...
export class TypeOrmTechnicianRepository implements ITechnicianRepository {
    ...
    async findById(id: TechnicianId | string): Promise<Result<Technician | null>> {
        try {
    ...
    async findByCorner(cornerId: string | CornerId): Promise<Result<Technician[]>> {
        try {
    ...
    private toDomain(entity: TechnicianEntity): Technician {
        return Technician.reconstitute(
            ...
            entity.full_name,
            entity.email,
            entity.corner_id ? CornerId(entity.corner_id as any) : null,
            entity.disabled,
            entity.created_at,
            entity.updated_at,
            entity.user_id ? UserId(entity.user_id as any) : null,
        );
    }
}