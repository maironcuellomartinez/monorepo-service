// apps/monolith/src/scripts/wipe-data.ts
//
...
async function main() {
    console.log('🧹 Monolith Data Wipe\n');
    ...
    try {
        ...
        for (const table of TABLES_IN_ORDER) {
            try {
                ...
                // La tabla puede no existir todavía si nunca arrancó el monolith
        ...
        console.log('   Reiniciá el monolith para que TypeORM sincronice la estructura.\n');
    } catch (err) {
        await qr.query('SET FOREIGN_KEY_CHECKS = 1');
