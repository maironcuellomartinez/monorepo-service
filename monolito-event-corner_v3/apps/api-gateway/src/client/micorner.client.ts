// api-gateway/client/micorner.client.ts
...
import { MICORNER_HTTP } from '../http/http-client.tokens';

@Injectable()
export class MicornerClient {
    private readonly authHeaders: Record<string, string>;

    constructor(@InjectHttpClient(MICORNER_HTTP) private readonly http: HttpClient) {
    ...
    private rethrow(err: HttpClientError): never {
        ...
        throw new InternalServerErrorException('Micorner unreachable');
    }
}
