...
function validateConfig(): void {
    ...
    const required: Record<string, string> = {
        JWT_SECRET:         'Secret para verificar JWT — debe coincidir con abac-microservice',
...
async function bootstrap() {
    ...
    if (env !== 'production') {
        const config = new DocumentBuilder()
            ...
            .setDescription('Punto de entrada unico para todas las operaciones de Event Corner v3')
            .setVersion('3.0')
