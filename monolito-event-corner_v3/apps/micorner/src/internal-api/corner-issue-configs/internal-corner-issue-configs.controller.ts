...
export class InternalCompanyIssueConfigsController {
    ...
    async create(@Body() dto: CreateCompanyIssueConfigDto) {
        return this.tracing.run('micorner.controller.issueConfigs.create', { kind: 'server' }, () => this._create(dto));
    }
    ...
    async update(
        ...
        return this.tracing.run('micorner.controller.issueConfigs.update', { kind: 'server', attributes: { 'issueConfig.id': id } }, () => this._update(id, dto));
    }
    ...
    async delete(@Param('id') id: string) {
        return this.tracing.run('micorner.controller.issueConfigs.delete', { kind: 'server', attributes: { 'issueConfig.id': id } }, () => this._delete(id));
    }
