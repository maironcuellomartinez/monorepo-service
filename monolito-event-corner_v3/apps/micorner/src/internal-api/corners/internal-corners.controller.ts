...
export class InternalCornersController {
    ...
    async create(@Body() dto: CreateCornerDto) {
        return this.tracing.run('micorner.controller.corners.create', { kind: 'server' }, () => this._create(dto));
    }
    ...
    async update(@Param('id') id: string, @Body() dto: UpdateCornerDto) {
        return this.tracing.run('micorner.controller.corners.update', { kind: 'server', attributes: { 'corner.id': id } }, () => this._update(id, dto));
    }
    ...
    async deactivate(@Param('id') id: string) {
        return this.tracing.run('micorner.controller.corners.deactivate', { kind: 'server', attributes: { 'corner.id': id } }, () => this._deactivate(id));
    }
    ...
    async addSchedule(@Param('id') cornerId: string, @Body() dto: AddScheduleDto) {
        return this.tracing.run('micorner.controller.corners.addSchedule', { kind: 'server', attributes: { 'corner.id': cornerId } }, () => this._addSchedule(cornerId, dto));
    }
    ...
    async updateSchedule(
        ...
        return this.tracing.run('micorner.controller.corners.updateSchedule', { kind: 'server', attributes: { 'schedule.id': scheduleId } }, () => this._updateSchedule(scheduleId, dto));
    }
    ...
    async deleteSchedule(
        ...
        return this.tracing.run('micorner.controller.corners.deleteSchedule', { kind: 'server', attributes: { 'schedule.id': scheduleId } }, () => this._deleteSchedule(scheduleId));
    }
    ...
    async assignTechnicians(
        ...
        return this.tracing.run('micorner.controller.corners.assignTechnicians', { kind: 'server', attributes: { 'schedule.id': scheduleId } }, () => this._assignTechnicians(scheduleId, dto));
    }
