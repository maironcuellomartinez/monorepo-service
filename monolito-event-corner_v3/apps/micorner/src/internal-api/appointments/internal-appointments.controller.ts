...
export class InternalAppointmentsController {
    ...
    async create(@Body() body: CreateAppointmentDto) {
        return this.tracing.run('micorner.controller.appointments.create', { kind: 'server' }, () => this._create(body));
    }
    ...
    async deliver(@Param('id') id: string, @Body() dto: DeliverAppointmentDto) {
        return this.tracing.run('micorner.controller.appointments.deliver', { kind: 'server', attributes: { 'appointment.id': id } }, () => this._deliver(id, dto));
    }
    ...
    async take(@Param('id') id: string, @Body() dto: TakeAppointmentDto) {
        return this.tracing.run('micorner.controller.appointments.take', { kind: 'server', attributes: { 'appointment.id': id } }, () => this._take(id, dto));
    }
    ...
    async release(@Param('id') id: string, @Body() dto: ReleaseAppointmentDto) {
        return this.tracing.run('micorner.controller.appointments.release', { kind: 'server', attributes: { 'appointment.id': id } }, () => this._release(id, dto));
    }
    ...
    async reschedule(@Param('id') id: string, @Body() dto: RescheduleAppointmentDto) {
        return this.tracing.run('micorner.controller.appointments.reschedule', { kind: 'server', attributes: { 'appointment.id': id } }, () => this._reschedule(id, dto));
    }
    ...
    async setEstimatedClose(@Param('id') id: string, @Body() dto: SetEstimatedCloseDto) {
        return this.tracing.run('micorner.controller.appointments.setEstimatedClose', { kind: 'server', attributes: { 'appointment.id': id } }, () => this._setEstimatedClose(id, dto));
    }
    ...
    async changeStatus(@Param('id') id: string, @Body() dto: ChangeStatusDto) {
        return this.tracing.run('micorner.controller.appointments.changeStatus', { kind: 'server', attributes: { 'appointment.id': id } }, () => this._changeStatus(id, dto));
    }
    ...
    async batchChangeStatus(@Body() body: BatchStatusChangeDto) {
        ...
        return this.tracing.run('micorner.controller.appointments.batchChangeStatus', { kind: 'server', attributes: { 'batch.count': String(body.items.length) } }, () => this._batchChangeStatus(body));
    }
    ...
    async validate(@Param('id') id: string, @Body() dto: ValidateAppointmentDto) {
        return this.tracing.run('micorner.controller.appointments.validate', { kind: 'server', attributes: { 'appointment.id': id } }, () => this._validate(id, dto));
    }
    ...
    async reopen(@Param('id') id: string, @Body() dto: ReopenAppointmentDto) {
        return this.tracing.run('micorner.controller.appointments.reopen', { kind: 'server', attributes: { 'appointment.id': id } }, () => this._reopen(id, dto));
    }
    ...
    async addNote(
        ...
        return this.tracing.run('micorner.controller.appointments.addNote', { kind: 'server', attributes: { 'appointment.id': id } }, () => this._addNote(id, body));
    }
    ...
    async cancel(@Param('id') id: string, @Body() dto: CancelAppointmentDto) {
        return this.tracing.run('micorner.controller.appointments.cancel', { kind: 'server', attributes: { 'appointment.id': id } }, () => this._cancel(id, dto));
    }
