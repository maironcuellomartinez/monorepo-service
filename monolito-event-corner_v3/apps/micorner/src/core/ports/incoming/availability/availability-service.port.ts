...
export interface SlotAvailabilityDto {
  ...
  /**
   * true si la ventana no está disponible pero el bloqueo es solo por holds
   * vigentes (lote en preparación), no por reservas BOOKED — la UI lo pinta
   * distinto porque puede liberarse si el lote se descarta o expira.
   */
  held?: boolean;
}
