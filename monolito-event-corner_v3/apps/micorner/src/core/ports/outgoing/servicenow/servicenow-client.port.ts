...
export interface ServiceNowIncidentPayload {
  ...
  severity: string;
  expected_start?: Date;
  /** ID del incident en el micorner — usado por snowq para deduplicar reintentos/re-encolados. */
  externalId?: string;
...
export interface ServiceNowRequestPayload {
  ...
  /** ID del request en el micorner — usado por snowq para deduplicar reintentos/re-encolados. */
  externalId?: string;
  /**
