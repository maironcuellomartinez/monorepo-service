...
export class AppointmentService implements IAppointmentService {
  ...
  async rescheduleAppointment(
    ...
    return this.tracing.run(
      'micorner.rescheduleAppointment',
      {
        kind: 'server',
        attributes: {
          'appointment.appointmentId': command.appointmentId,
