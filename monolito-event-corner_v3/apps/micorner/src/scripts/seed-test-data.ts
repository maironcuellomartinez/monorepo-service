// apps/micorner/src/scripts/seed-test-data.ts
//
// Seed de datos de prueba para el micorner de Event Corner.
//
...
// Load micorner env (works from monorepo root or from the micorner dir)
...
const IDS = {
    ...
    users: {
        empleado1: 'user-empleado1-micorner-000001',
        empleado2: 'user-empleado2-micorner-000001',
    },
};
...
function printSummary() {
    const sep = '═'.repeat(72);
    console.log(`\n${sep}`);
    console.log('  MICORNER — DATOS DE PRUEBA CREADOS');
    console.log(sep);
