...
const COMPANIES = [
    ...
    },
    {
        ...
        country:     'Global',
        city:        'Santander',
        notes:       'Empresa por defecto — usar cuando no hay perfil específico (SN_DEFAULT_COMPANY_SYS_ID)',
    },
];
...
async function main() {
    console.log('🚀 Iniciando seed de datos de referencia en servicenow_clone...\n');
    ...
    try {
        ...
        if (parseInt(existing[0].cnt) > 0) {
            console.log('⚠️  Ya existen registros de referencia. Omitiendo...');
            console.log('   (borrá los registros con table_name core_company / sys_user_group para re-ejecutar)\n');
            return;
        }
